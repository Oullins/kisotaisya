...
function goFilter2(){
  ...
  // --- 選択されている商品のクラスを割り当てる ---
  if(document.getElementById("chkKokurui").checked)    {value += ' kokurui';}
  if(document.getElementById("chkNamamen").checked)   {value += ' namamen';}
  if(document.getElementById("chkKanmen").checked)   {value += ' kanmen';}
